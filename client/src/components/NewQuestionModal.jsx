...
import { X, MessageSquare, FileText, Send, Sparkles, AlertCircle } from 'lucide-react';
    ...
    return (
      ...
      `}</style>
            ...
            <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-50 p-4">
                <div className={`glassmorphism-modal rounded-3xl shadow-2xl max-w-3xl w-full max-h-[95vh] overflow-hidden transform transition-all duration-300 ${isOpen ? 'scale-100 opacity-100' : 'scale-95 opacity-0'
                    }`}>
                    ...
                    <div className="bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 px-8 py-6 text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex items-center gap-3 mt-4">
                                ...
                                <div className={`category-badge px-4 py-2 rounded-full text-white text-sm font-semibold flex items-center gap-2 shadow-lg`}>
                    ...
                    >
                        ...
                        <div className="space-y-3">
                            <label className={`block text-lg font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                            ...
                            <select
                                ...
                                className={`w-full px-6 py-4 rounded-2xl border-2 transition-all duration-300 focus:outline-none text-lg font-medium ${isDarkMode
                            ...
                            >
                                {categories.map(cat => (
                                    <option key={cat.value} value={cat.value} className={isDarkMode ? 'bg-gray-800' : 'bg-white'}>
                                        {cat.icon} {cat.label}
                                    </option>
                                ))}
                            </select>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className={`relative input-glow rounded-2xl transition-all duration-300 ${errors.title ? 'ring-2 ring-red-500' : ''
                                }`}>
                                <FileText className={`absolute left-4 top-1/2 transform -translate-y-1/2 w-6 h-6 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'
                                    }`} />
                                <input
                                    type="text"
                                    name="title"
                                    ...
                                    className={`w-full pl-14 pr-6 py-4 rounded-2xl border-2 transition-all duration-300 focus:outline-none text-lg ${isDarkMode
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <p className={`text-sm font-medium ${formData.title.length > 130 ? 'text-red-500' : isDarkMode ? 'text-gray-400' : 'text-gray-500'
                                    }`}>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className={`relative input-glow rounded-2xl transition-all duration-300 ${errors.description ? 'ring-2 ring-red-500' : ''
                                }`}>
                                <textarea
                                    name="description"
                                    ...
                                    rows={6}
                                    className={`w-full px-6 py-4 rounded-2xl border-2 transition-all duration-300 focus:outline-none resize-none text-lg leading-relaxed textarea-scrollbar ${isDarkMode
                                            ? 'bg-gray-800 border-gray-600 text-white placeholder-gray-400 focus:border-pink-500'
                                            : 'bg-white border-gray-200 text-gray-900 placeholder-gray-500 focus:border-blue-500'
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <p className={`text-sm font-medium ${formData.description.length > 900 ? 'text-red-500' : isDarkMode ? 'text-gray-400' : 'text-gray-500'
                                    }`}>
                        ...
                        {/* Guidelines */}
                        <div className={`rounded-2xl p-6 border-2 ${isDarkMode
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h4 className={`font-bold text-lg ${isDarkMode ? 'text-purple-300' : 'text-purple-800'
                                    }`}>
                        ...
                        {/* Action Buttons */}
                        <div className="flex gap-4 pt-6 border-t-2" style={{
                            borderColor: isDarkMode ? '#374151' : '#e5e7eb'
                        }}>
                            <button
                                type="button"
                                onClick={handleClose}
                                className={`flex-1 px-8 py-4 border-2 font-bold rounded-2xl transition-all duration-300 hover:scale-105 ${isDarkMode
                        ...
                        {/* Scroll Indicator */}
                        <div className={`text-center text-xs ${isDarkMode ? 'text-gray-500' : 'text-gray-400'} pb-2`}>
                            ↕ Scroll to see more
                        </div>
                    </form>
                </div>
