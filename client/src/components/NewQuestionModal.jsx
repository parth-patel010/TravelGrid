  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-50 p-4">
        <div className={`glassmorphism-modal rounded-3xl shadow-2xl max-w-3xl w-full max-h-[95vh] overflow-hidden transform transition-all duration-300 ${
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className={`relative input-glow rounded-2xl transition-all duration-300 ${
                ...
                <FileText className={`absolute left-4 top-1/2 transform -translate-y-1/2 w-6 h-6 ${
              ...
              <div className="flex justify-between items-center">
                ...
                <p className={`text-sm font-medium ${
                  formData.title.length > 130 ? 'text-red-500' : isDarkMode ? 'text-gray-400' : 'text-gray-500'
                }`}>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <p className={`text-sm font-medium ${
                  formData.description.length > 900 ? 'text-red-500' : isDarkMode ? 'text-gray-400' : 'text-gray-500'
                }`}>
