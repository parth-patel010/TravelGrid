        ...
        {packages.map((pkg, i) => (
          ...
          >
            ...
            <div className="p-5 flex-1 flex flex-col justify-between">
              ...
              <button className="mt-auto w-full bg-pink-500 hover:bg-pink-600 text-white font-semibold py-2 px-4 rounded-xl transition-colors duration-200 transform hover:scale-105">
                Book Now
              </button>
            </div>
          </div>
