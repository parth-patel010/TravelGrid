...
// Combine the testimonials array with itself for a seamless loop
          ...
          <div className="flex w-max scroller">
            {extendedTestimonials.map((t, i) => (
              ...
              >
                ...
                <p
                  className={`text-sm mb-6 leading-relaxed group-hover:text-gray-800 transition-colors duration-300 break-words ${
                    isDarkMode
