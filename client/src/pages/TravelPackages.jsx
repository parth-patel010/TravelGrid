...
const packages = [
    ...
    reviews: [
      {
        user: "Alice",
        comment:
          "Loved the European Explorer – Italy & France! Highly recommend.",
      },
      { user: "Bob", comment: "Great experience, would book again." },
    ],
  },
  {
    ...
    reviews: [
      {
        user: "Alice",
        comment: "Loved the Desert Delight – Dubai! Highly recommend.",
      },
      { user: "Bob", comment: "Great experience, would book again." },
    ],
  },
  {
    ...
    reviews: [
      {
        user: "Alice",
        comment: "Loved the Himalayan Adventure – Manali! Highly recommend.",
      },
      { user: "Bob", comment: "Great experience, would book again." },
    ],
  },
          ...
          {packages.map((pkg) => (
            ...
            >
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <button className="mt-auto self-start bg-gradient-to-r from-pink-600 to-pink-500 hover:from-pink-500 hover:to-pink-600 text-white px-5 py-2 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105">
                  Book Now
                </button>
              </div>
            </div>
