...
const PetTravel = () => {
    ...
    const sectionHeadingClass = isDarkMode ? 'text-pink-300' : 'text-pink-600';
    
    return (
        <div className={`mx-auto p-4 min-h-screen w-full overflow-x-hidden transition-all duration-300 ${backgroundClass}`}>
            <div className={`backdrop-blur-md rounded-2xl shadow-2xl p-8 border max-w-xl mx-auto my-8 mt-20 transition-all duration-300 ${cardClass}`}>
                <h2 className={`text-3xl md:text-4xl font-bold text-center mb-6 ${headingClass}`}>
                    Pet Travel Guide
                </h2>

                <div className="space-y-6">
                    <div>
                        <h3 className={`text-xl font-semibold mb-2 ${sectionHeadingClass}`}>🐾 Know Before You Go</h3>
                    ...
                    <div>
                        <h3 className={`text-xl font-semibold mb-2 ${sectionHeadingClass}`}>🧳 Pack Essentials for Your Pet</h3>
                        <p className="text-sm leading-relaxed">
                    ...
                    <div>
                        <h3 className={`text-xl font-semibold mb-2 ${sectionHeadingClass}`}>🚗 Safety During Travel</h3>
                        <p className="text-sm leading-relaxed">
                    ...
                    <div>
                        <h3 className={`text-xl font-semibold mb-2 ${sectionHeadingClass}`}>🐶 Pet-Friendly Stays</h3>
                        <p className="text-sm leading-relaxed">
                    ...
                    <div>
                        <h3 className={`text-xl font-semibold mb-2 ${sectionHeadingClass}`}>🌿 Respect Local Rules</h3>
                        <p className="text-sm leading-relaxed">
                    ...
                    <div>
                        <h3 className={`text-xl font-semibold mb-2 ${sectionHeadingClass}`}>🌎 International Travel Notes</h3>
                        <p className="text-sm leading-relaxed">
