...
def get_github_token() -> str:
    ...
    token = os.getenv("GITHUB_TOKEN", "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")  # Replace with your actual token
    if not token:
